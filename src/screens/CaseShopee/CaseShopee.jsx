      ...
      <div className="div-2">
        <div className="overlap-3">
          ...
          <div className="frame-40">
            <div className="frame-41">
              <p className="case-shopee-e-o">
                ...
                <span className="text-wrapper-37">E o Serviço de tradução de E-commerce</span>
              </p>
              <p className="text-wrapper-38">Faça como a Shopee, abra um novo mercado com a gente</p>
            </div>
          ...
          <div className="idiomas">
            ...
            <div className="text-wrapper-40">30 milhões de</div>
        ...
        <FaleComUm className="design-component-instance-node" property1="default" />
