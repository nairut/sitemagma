      ...
      <div className="div-3">
          ...
          <div className="frame-49">
            <div className="frame-50">
              <p className="o-caso-ZF-e-o-servi">
                ...
                <span className="text-wrapper-47">E o Serviço de tradução automotiva</span>
              </p>
              <p className="text-wrapper-48">Faça como a ZF, abra um novo mercado com a gente</p>
            </div>
        ...
        <div className="group-22">
          <div className="overlap-6">
            ...
            <p className="text-wrapper-55">Magma Translation | Todos os direitos reservados. ©Magma™</p>
          </div>
        </div>
