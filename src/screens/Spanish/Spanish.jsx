  ...
  return (
    <div className="spanish">
      <div className="div-2">
        <div className="overlap-6">
          <div className="overlap-7">
            ...
            <div className="group-5">
              <h1 className="text-wrapper-6">Top-Quality Spanish Translation Services</h1>
        ...
        <p className="text-wrapper-8">Costumized to Fit your Specific Industry Needs</p>
        <img className="zapier-png" alt="Zapier png" src="/img/zapier-png-0.png" />
        <img className="abbott-png" alt="Abbott png" src="/img/abbott-png-0-4.png" />
        <img className="zf-png" alt="Zf png" src="/img/zf-png-0.png" />
        <img className="anton-paar-png" alt="Anton paar png" src="/img/anton-paar-png-0-4.png" />
        <img className="crowdin-png" alt="Crowdin png" src="/img/crowdin-png-0.png" />
        <img className="rectangle-7" alt="Rectangle" src="/img/rectangle-13-4.png" />
        <img className="cloudwords-png" alt="Cloudwords png" src="/img/cloudwords-png-0.png" />
        <img className="rectangle-8" alt="Rectangle" src="/img/rectangle-14-4.png" />
        <img className="rectangle-9" alt="Rectangle" src="/img/rectangle-7.png" />
        <img className="rectangle-10" alt="Rectangle" src="/img/rectangle-15-4.png" />
        <img className="rectangle-11" alt="Rectangle" src="/img/rectangle-8.png" />
        <img className="evoltz-png" alt="Evoltz png" src="/img/evoltz-png-0-4.png" />
        ...
        <img className="shopee-png" alt="Shopee png" src="/img/shopee-png-0-4.png" />
        <div className="overlap-8">
          <div className="text-wrapper-9">Legal</div>
          <img className="law" alt="Law" src="/img/law-2.png" />
        </div>
        <div className="overlap-9">
          <div className="media-films">Media &amp; Films</div>
          <img className="next" alt="Next" src="/img/next-2.png" />
        </div>
        <div className="overlap-10">
          <div className="text-wrapper-10">Medical</div>
          <img className="img-2" alt="Medical bag" src="/img/medical-bag-2.png" />
        </div>
        <div className="overlap-11">
          <div className="text-wrapper-11">E-Learning</div>
          <img className="img-2" alt="Mba" src="/img/mba-2.png" />
        </div>
        <div className="overlap-12">
          <div className="text-wrapper-12">Manufacturing</div>
          <img className="img-2" alt="Manufacturing" src="/img/manufacturing-2.png" />
        </div>
        <div className="overlap-13">
          <div className="text-wrapper-13">Automotive</div>
          <img className="img-2" alt="Tesla model x" src="/img/tesla-model-x-2.png" />
        </div>
        <div className="overlap-14">
          <div className="text-wrapper-14">Financial</div>
          <img className="money-bag-pounds" alt="Money bag pounds" src="/img/money-bag-pounds-2.png" />
        </div>
        <div className="overlap-group-3">
          <div className="text-wrapper-15">Marketing</div>
          <img className="img-2" alt="Commercial" src="/img/commercial-2.png" />
        </div>
        <div className="overlap-15">
          <div className="text-wrapper-12">IT &amp; Software</div>
          <img className="img-2" alt="Programming flag" src="/img/programming-flag-2.png" />
        </div>
        <div className="overlap-16">
          <div className="text-wrapper-16">Life Science</div>
          <img className="img-2" alt="Biotech" src="/img/biotech-4.png" />
        </div>
        <div className="overlap-17">
          <div className="text-wrapper-14">Tourism</div>
          <img className="img-2" alt="Plane" src="/img/plane-2.png" />
        </div>
        <div className="overlap-18">
          <div className="text-wrapper-17">E-commerce</div>
          <img className="img-2" alt="Buy" src="/img/buy-2.png" />
        </div>
        <div className="text-wrapper-18">What can you translate?</div>
        ...
        <div className="overlap-22">
          <div className="text-wrapper-20">Video Subtitling</div>
          <img className="img-3" alt="Video camera" src="/img/video-camera-2.png" />
        </div>
        <div className="overlap-23">
          <div className="text-wrapper-21">Product Descriptions</div>
          <img className="img-3" alt="E commerce" src="/img/e-commerce-2.png" />
        </div>
        <div className="overlap-24">
          <div className="text-wrapper-22">Articles, certificates, and more</div>
          <img className="biotech" alt="Biotech" src="/img/biotech-4.png" />
        </div>
        <Group
          ...
          to="/desktop-form"
        />
        <Group className="group-6" property1="default" talkToAnExpertClassName="group-2-instance" to="/desktop-form" />
        ...
        <img className="ellipse-2" alt="Ellipse" src="/img/ellipse-2-2.png" />
        <img className="ellipse-3" alt="Ellipse" src="/img/ellipse-3-2.png" />
