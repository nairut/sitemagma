      ...
      <div className="div-2">
        ...
        <div className="group-6">
          ...
          <div className="group-7">
            ...
            <div className="overlap-7">
              <div className="text-wrapper-11">Marketing e Anúncios</div>
              <img className="img-2" alt="Goal" src="/img/goal.png" />
            </div>
            <div className="overlap-group-3">
              <div className="website-apps">Website &amp; Apps</div>
              <img className="img-2" alt="Website" src="/img/website.png" />
            </div>
            <div className="overlap-8">
              <div className="text-wrapper-12">Vídeos</div>
              <img className="img-2" alt="Video camera" src="/img/video-camera.png" />
            </div>
            <div className="overlap-9">
              <div className="text-wrapper-13">Descrições de produtos</div>
              <img className="img-2" alt="E commerce" src="/img/e-commerce.png" />
            </div>
            <div className="overlap-10">
              <div className="text-wrapper-14">Artigos e muito mais</div>
        ...
        <div className="group-8">
          ...
          <div className="group-9">
            ...
            <div className="text-wrapper-19">Anton Paar</div>
            <div className="overlap-group-4">
              <div className="text-wrapper-20">Museu do Amanhã</div>
              <div className="text-wrapper-21">Ricardo de Aquino Silva</div>
            </div>
