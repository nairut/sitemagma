  ...
  return (
    <div className="home-pt">
      <div className="div-2">
          ...
          <div className="chamadadeentrada">
            <div className="overlap-group-3">
              ...
              <div className="textoebotao">
                ...
                property1="default" 
                textoBotao={textoBotao} to="https://pages.magmatranslation.com/solicite-um-orcamento" />
              </div>
            </div>
          </div>
        </div>
        ...
        <ButtonPortugues className="botao-brasileiro" property1="default" to="https://pages.magmatranslation.com/solicite-um-orcamento"  textoBotao={textoBotao} />
        ...
        <ButtonPortugues className="design-component-instance-node" property1="default" to="https://pages.magmatranslation.com/solicite-um-orcamento" textoBotao={textoBotao} />
