...
export const Dropdown = ({
  ...
  icon = <IconEnd1Medium className={iconEnd1MediumStyleOverrideClassName} color={iconEnd1MediumColor} />,
  inputType = "text",
}) => {
  return (
          ...
          <div className={`input ${appearance} ${size}`}>
            <div className={`contents size-${size} appearance-${appearance} ${theme}`}>
              ...
              <div className="icon-end">
                ...
                {size === "medium" && (
                  <IconEnd1Medium className="icon-end-medium" color={theme === "dark-mode" ? "#ADADAD" : "#616161"} />
                )}
              </div>
            </div>
...
Dropdown.propTypes = {
  ...
  iconEnd1MediumColor: PropTypes.string,
