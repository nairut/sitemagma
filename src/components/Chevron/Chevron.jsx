...
import { DirectionLeftSize28ThemeFilled2 } from "../../icons/DirectionLeftSize28ThemeFilled2";
import { DirectionRightSize28ThemeFilled2 } from "../../icons/DirectionRightSize28ThemeFilled2";
import "./style.css";
        ...
        <img
          ...
          src={
            size === "forty-eight" && theme === "filled" && direction === "up"
              ? "/img/direction-up-size-48-theme-filled-2.png"
              : theme === "regular" && size === "twenty-eight" && direction === "up"
              ? "/img/direction-up-size-28-theme-regular-2.png"
              : theme === "filled" && size === "twenty-eight" && direction === "up"
              ? "/img/direction-up-size-28-theme-filled-2.png"
              : theme === "regular" && size === "twenty-four" && direction === "up"
              ? "/img/direction-up-size-24-theme-regular-2.png"
              : size === "twenty-four" && direction === "up" && theme === "filled"
              ? "/img/direction-up-size-24-theme-filled-2.png"
              : theme === "regular" && size === "twenty" && direction === "up"
              ? "/img/direction-up-size-20-theme-regular-2.png"
              : theme === "filled" && size === "twenty" && direction === "up"
              ? "/img/direction-up-size-20-theme-filled-2.png"
              : theme === "regular" && size === "sixteen" && direction === "up"
              ? "/img/direction-up-size-16-theme-regular-2.png"
              : theme === "filled" && size === "sixteen" && direction === "up"
              ? "/img/direction-up-size-16-theme-filled-2.png"
              : theme === "regular" && direction === "up" && size === "twelve"
              ? "/img/direction-up-size-12-theme-regular-2.png"
              : direction === "up" && theme === "filled" && size === "twelve"
              ? "/img/direction-up-size-12-theme-filled-2.png"
              : direction === "right" && theme === "regular" && size === "forty-eight"
              ? "/img/direction-right-size-48-theme-regular-2.png"
              : direction === "right" && theme === "filled" && size === "forty-eight"
              ? "/img/direction-right-size-48-theme-filled-2.png"
              : direction === "right" && size === "twenty-four" && theme === "regular"
              ? "/img/direction-right-size-24-theme-regular-2.png"
              : direction === "right" && size === "twenty-four" && theme === "filled"
              ? "/img/direction-right-size-24-theme-filled-2.png"
              : direction === "right" && theme === "regular" && size === "twenty"
              ? "/img/direction-right-size-20-theme-regular-2.png"
              : direction === "right" && theme === "filled" && size === "twenty"
              ? "/img/direction-right-size-20-theme-filled-2.png"
              : direction === "right" && theme === "regular" && size === "sixteen"
              ? "/img/direction-right-size-16-theme-regular-2.png"
              : direction === "right" && theme === "filled" && size === "sixteen"
              ? "/img/direction-right-size-16-theme-filled-2.png"
              : direction === "right" && theme === "regular" && size === "twelve"
              ? "/img/direction-right-size-12-theme-regular-2.png"
              : direction === "right" && theme === "filled" && size === "twelve"
              ? "/img/direction-right-size-12-theme-filled-2.png"
              : direction === "left" && theme === "regular" && size === "forty-eight"
              ? "/img/direction-left-size-48-theme-regular-2.png"
              : direction === "left" && theme === "filled" && size === "forty-eight"
              ? "/img/direction-left-size-48-theme-filled-2.png"
              : direction === "left" && size === "twenty-four" && theme === "regular"
              ? "/img/direction-left-size-24-theme-regular-2.png"
              : direction === "left" && size === "twenty-four" && theme === "filled"
              ? "/img/direction-left-size-24-theme-filled-2.png"
              : direction === "left" && theme === "regular" && size === "twenty"
              ? "/img/direction-left-size-20-theme-regular-2.png"
              : direction === "left" && theme === "filled" && size === "twenty"
              ? "/img/direction-left-size-20-theme-filled-2.png"
              : direction === "left" && theme === "regular" && size === "sixteen"
              ? "/img/direction-left-size-16-theme-regular-2.png"
              : direction === "left" && theme === "filled" && size === "sixteen"
              ? "/img/direction-left-size-16-theme-filled-2.png"
              : direction === "left" && theme === "regular" && size === "twelve"
              ? "/img/direction-left-size-12-theme-regular-2.png"
              : direction === "left" && theme === "filled" && size === "twelve"
              ? "/img/direction-left-size-12-theme-filled-2.png"
              : size === "forty-eight" && direction === "down" && theme === "regular"
              ? "/img/direction-down-size-48-theme-regular-2.png"
              : size === "forty-eight" && direction === "down" && theme === "filled"
              ? "/img/direction-down-size-48-theme-filled-2.png"
              : theme === "regular" && direction === "down" && size === "twenty-eight"
              ? "/img/direction-down-size-28-theme-regular-2.png"
              : direction === "down" && theme === "filled" && size === "twenty-eight"
              ? "/img/direction-down-size-28-theme-filled-2.png"
              : theme === "regular" && direction === "down" && size === "twenty-four"
              ? directionDownSize1
              : direction === "down" && size === "twenty-four" && theme === "filled"
              ? "/img/direction-down-size-24-theme-filled-2.png"
              : theme === "regular" && direction === "down" && size === "twenty"
              ? directionDownSize
              : direction === "down" && theme === "filled" && size === "twenty"
              ? "/img/direction-down-size-20-theme-filled-2.png"
              : theme === "regular" && direction === "down" && size === "sixteen"
              ? img
              : direction === "down" && theme === "filled" && size === "sixteen"
              ? "/img/direction-down-size-16-theme-filled-2.png"
              : theme === "regular" && direction === "down" && size === "twelve"
              ? "/img/direction-down-size-12-theme-regular-2.png"
              : direction === "down" && theme === "filled" && size === "twelve"
              ? "/img/direction-down-size-12-theme-filled-2.png"
              : "/img/direction-up-size-48-theme-regular-2.png"
          }
        />
      )}

      {direction === "right" && size === "twenty-eight" && (
        <DirectionRightSize28ThemeFilled2 className="instance-node" />
      )}

      {direction === "left" && size === "twenty-eight" && <DirectionLeftSize28ThemeFilled2 className="instance-node" />}
    </>
  );
};
