...
export const DirectionLtrSize20ThemeFilled = ({ className }) => {
  return (
    <svg
      className={`direction-ltr-size-20-theme-filled ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
