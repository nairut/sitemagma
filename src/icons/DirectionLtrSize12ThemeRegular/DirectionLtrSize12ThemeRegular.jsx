...
export const DirectionLtrSize12ThemeRegular = ({ className }) => {
  return (
    <svg
      className={`direction-ltr-size-12-theme-regular ${className}`}
      fill="none"
      height="12"
      viewBox="0 0 12 12"
      width="12"
